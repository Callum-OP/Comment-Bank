...
<div class="container"> 
    ...
    <form method="post" action="{{ route('results.update', $results->id) }}"> 
        ...
        <div class="form-group">     
            ...
            <input type="text" class="form-control" name="comment" value="{{ $results->comment }}" required> 
        </div>  
        <div class="form-group"> 
        ...
        <label for="first_name">First Name:</label> 
            <input type="text" class="form-control" name="first_name" value="{{ $results->first_name }}" required> 
        </div> 
        <div class="form-group"> 
            <label for="last_name">Last Name:</label> 
            <input type="text" class="form-control" name="last_name" value="{{ $results->last_name }}" required> 
        </div> 
        <div class="form-group"> 
